<template>
        <v-app-bar app color="white" elevate-on-scroll>
            ...
            <v-toolbar-title class="headline text-uppercase mr-4 homebar-logo">
                <v-card color="transparent" flat>
                    <router-link to="/" class="homebar-link">
            ...
            <v-layout align-center class="homebar-funds-label">
                <span class="text-uppercase grey--text text--darken-2">
                    <span class="homebar-funds-text">Remaining:</span>
                    <span class="homebar-funds-text1">{{funds | dollarsign}}</span>
                </span>
            </v-layout>
            <v-spacer></v-spacer>
